            ...
            if schedule_data:
                ...
                for day, lessons in days.items():
                    ...
                    for lesson in lessons:
                        ...
                        teacher_lbl = QLabel(teacher_name)
                        teacher_lbl.setStyleSheet("""
                            font-family: Roboto; 
                            font-size: 12px; 
                            color: #7f8c8d; 
                            background: transparent; 
                            border: none;
                        """)
                        teacher_lbl.setAlignment(Qt.AlignRight | Qt.AlignVCenter)
                        ...
                        row_layout.addWidget(teacher_lbl, stretch=1)
